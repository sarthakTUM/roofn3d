...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmdb_train', default='/media/sarthak/HDD/TUM/courses/sem_5/ADLCV/pointnet.pytorch/data/damaged_v10_1000pts_meansubtrain/data.mdb')
    parser.add_argument('--lmdb_valid', default='/media/sarthak/HDD/TUM/courses/sem_5/ADLCV/pointnet.pytorch/data/damaged_v10_1000pts_meansubval/data.mdb')
    parser.add_argument('--log_dir', default='log/home_v10_cd')
    ...
    parser.add_argument('--steps_per_save', type=int, default=50)
